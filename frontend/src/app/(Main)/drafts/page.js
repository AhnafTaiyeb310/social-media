...
import { usePosts, useDeletePost } from '@/features/post/hooks/usePost';
...
export default function DraftsPage() {
  ...
  const confirmDelete = () => {
    ...
    deletePost(postToDelete.id, {
      onSuccess: () => {
        if (window.HSOverlay) {
          window.HSOverlay.close('#hs-delete-post-modal');
        }
    ...
    <div className="min-h-screen bg-layer px-4">
            ...
            filteredPosts.map((post) => (
              ...
              >
                ...
                <div className="hs-dropdown relative inline-flex">
                  ...
                  >
                    <button className="flex items-center gap-x-3 py-2 px-3 w-full rounded-lg text-sm text-gray-800 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-700 transition-colors">
      ...
      <div id="hs-delete-post-modal" className="hs-overlay hidden size-full fixed top-0 start-0 z-[100] overflow-x-hidden overflow-y-auto pointer-events-none flex items-center justify-center">
        <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
          <div className="relative flex flex-col bg-white border shadow-sm rounded-2xl dark:bg-neutral-900 dark:border-neutral-800 pointer-events-auto w-full">
            <div className="p-4 sm:p-10 text-center">
              ...
              <div className="mt-8 flex justify-center gap-x-3">
                <button 
                  type="button" 
                  className="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-800 dark:text-white dark:hover:bg-neutral-800" 
                  data-hs-overlay="#hs-delete-post-modal"
                >
                  Cancel
                </button>
